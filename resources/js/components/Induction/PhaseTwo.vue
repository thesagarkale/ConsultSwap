<template>
    <div class="animate__animated animate__fadeIn">
        <div class="c-Induction_header font-bold text-white z-10 text-indigo-400" style="padding-top: 6rem">
            Before we get started ...
        </div>
        <div class="c-Induction_categories">
            <div class="text-white pt-8 font-bold c-Induction_categories_text">
            ...
            <div class="pt-8 flex flex-wrap">
                <div v-for="category in categories" style="font-size: 2rem" @click="updateSelected(category.id)"
                     class="capitalize mt-4 mr-4 pl-5
                                pr-5 pt-2 pb-2 border rounded-full break-words border-white text-white hover:bg-indigo-400
                                hover:border-indigo-400 cursor-pointer font-extralight"
                     :class="{'bg-indigo-400 border-indigo-400': selected.indexOf(category.id) !== -1}">
                    {{ category.label }}
                </div>
            </div>
        </div>
